...
// TxPoolContent returns the current contents of the pending pool.
// NOTE: Unmarshalling the result into type rpcTransaction loses all
// transaction data except (blockNumber, blockHash, from).
